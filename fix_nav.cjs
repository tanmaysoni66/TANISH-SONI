...
const token1 = '<AnimatePresence>\n        {mobileMenuOpen && (';
const token2 = '    </>\n  );\n};\n\nconst Hero = () => {';

const idx1 = content.lastIndexOf(token1, content.indexOf('Hero = () =>'));
const idx2 = content.indexOf(token2);
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 z-[9998] lg:hidden flex flex-col justify-end">
            ...
            <motion.div
              ...
              className="relative w-full max-h-[90vh] flex flex-col bg-slate-50/90 dark:bg-[#09090b]/90 backdrop-blur-2xl rounded-t-[2.5rem] border-t border-white/40 dark:border-white/10 shadow-[0_-20px_50px_rgba(0,0,0,0.2)] pb-safe overflow-hidden z-[9999]"
            >
              ...
              <div className="flex items-center justify-between px-6 pb-4 pt-2">
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-white/50 dark:bg-white/5 border border-white/50 dark:border-white/10 flex items-center justify-center shadow-sm overflow-hidden p-1.5 shrink-0">
                    <img
                          ...
                          <div className={baseCardClass}>
                            ...
                            <AnimatePresence>
                              {isExpanded && (
                                ...
                                >
                                  <div className="px-4 py-2 flex flex-col gap-1 border-t border-white/30 dark:border-white/5">
...
console.log("Nav replaced cleanly");
